...
const paymentPage = () => {
    ...
    const handlePayUPayment = () => {
        ...
        const surl = "http://localhost:3000/api/payment-success";
        const furl = "http://localhost:3000/api/payment-failure";
    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            const options = {
                ...
                callback_url: "http://localhost:3000/api/payment-success-rz",
                theme: {
                    color: "#3a88fe",
                },
            };
